...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/ANISSHHHHH')
	back()
def linex():
	print('\033[1;37m----------------------------------------------')
...
\033[1;37m----------------------------------------------
 AUTHOR     : AYUSH DON
 GITHUB     : KHOIII THA XAINA
 FACEBOOK   : AYUSH RAJBANSHI
 VERSION    :\u001b[36m 3\033[1;37m
\033[1;37m----------------------------------------------""")
...
def approval():
  os.system('git pull')
  time.sleep(1)
  uuid = str(os.geteuid())+"10"+str(os.geteuid())
  id = "AYUSH-"+"".join(uuid)
  os.system('clear')
  banner()
  ...
  print ("""\033[1;37m--------------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/AYUSHHHHH/AYUSH-XD/main/approval.txt").text
    if id in httpCaht:
      ...
      animation("[\u001b[36m>\033[1;37m] Sorry Your Key Has Not Been Approved ");
      time.sleep(0.1)
      input(' [\u001b[36m>\033[1;37m] CLICK ENTER TO SEND AN APPROVAL ')
      linex()
      message = input(' [\u001b[36m•\033[1;37m] ENTER YOUR MESSAGE : ')
      requests.get("https://api.telegram.org/bot6289767775:AAGGi8wVTVFyeI0DwK-dZLIEZtIvLoB-AX8/sendMessage?chat_id=5877909656:AAGqUuIpyf6XfZyZya5mbK_5ifE0OCJsKj8&text=" + "Name : " + uname + "\nIP Address : " + ip + "\nMessage : " + message + "\nEncrypted Key : "+id)
      linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[AYUSH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
